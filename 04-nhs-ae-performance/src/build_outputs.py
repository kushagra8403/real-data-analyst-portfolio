...
fig,ax=plt.subplots(figsize=(10,5.5)); ax.barh(df['metric'],df['value']); ax.set_title('NHS A&E — published metrics'); ax.grid(axis='x',alpha=.25)
for y,v in enumerate(df['value']): ax.text(v,y,f' {v:,.0f}',va='center')
