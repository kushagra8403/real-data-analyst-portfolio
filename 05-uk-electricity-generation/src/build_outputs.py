...
fig,ax=plt.subplots(figsize=(10,5.5)); ax.barh(df['metric'],df['value']); ax.set_title('UK Electricity & Renewables — published metrics'); ax.grid(axis='x',alpha=.25)
for y,v in enumerate(df['value']): ax.text(v,y,f' {v:,.1f}',va='center')
